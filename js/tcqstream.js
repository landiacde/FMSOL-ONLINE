/*
TCQSTREAM PLAYER: FRANCO ZAMORA
https://www.tcqstream.com

Copyright (C) TCQSTREAM | FRANCO ZAMORA
https://www.tcqstream.com
...
(function(d, D) {
    ...
    d.fn.tcqstream = function(m) {
        ...
        w ? this.each(function() {
            var G = d(this).data("tcqstream"),
                F = G && d.isFunction(G[m]) ? G[m].apply(G, t) : G;
            if (F !== G && F !== D) return K = F, !1
        }) : this.each(function() {
            d(this).data("tcqstream", new d.tcqstream(this,
                m))
        });
        return K
    };
    d.tcqstream = function(m, w) {
        function t(b, a) {
        ...
        function P() {
            ...
            b.innerHTML = "";
            d("#" + c).addClass("tcqaudioplayer").css({
                overflow: "hidden",
                display: "block"
            });
...
if (w.metadatatechnic === "corsproxy") {
        ...
        function nb(b) {
            ...
            d("#" + c + "textradioname").css({
                ...
                "font-family": aa,
                color: x
            }).addClass(c + "textradioname").html(d("." + c + "textradionamespan")).tcqstreamdisableSelection();
            m = document.createElement("span");
            ...
            d("#" + c + "texttitle").css({
                ...
                "font-family": aa,
                color: x
            }).addClass(c + "texttitle").html(d("." + c + "texttitlespan")).tcqstreamdisableSelection();
            m = document.createElement("div");
            ...
            d("#" +
                ...
                "font-family": "Roboto",
                color: x
            }).html("100").tcqstreamdisableSelection();
            xb(a);
            yb(a);
        ...
        function Wa(b) {
            if ("true" == zb) {
                var a = "";
                "small" == ja && (a = "small");
                b && d("#" + c + a + "texttitle").hasClass(c + "Marquee") && (d("#" + c + a + "texttitle").removeClass(c + "Marquee"), d("#" + c + a + "texttitle").html(d("." + c + a + "texttitlespan").first()), d("#" + c + a + "texttitle").data("tcqstreamMarquee").pause());
                d("#" + c + a + "textradioname").width() > d("." +
                    c + a + "textradionamespan").first().width() ? d("#" + c + a + "textradioname").hasClass(c + "Marquee") && (d("#" + c + a + "textradioname").removeClass(c + "Marquee"), d("#" + c + a + "textradioname").html(d("." + c + a + "textradionamespan").first()), d("#" + c + a + "textradioname").data("tcqstreamMarquee").pause()) : d("#" + c + a + "textradioname").hasClass(c + "Marquee") || (d("#" + c + a + "textradioname").addClass(c + "Marquee"), d("#" + c + a + "textradioname").html(d("." + c + a + "textradionamespan").first()), d("#" + c + a + "textradioname").tcqstreamMarquee());
                d("#" +
                    c + a + "texttitle").width() > d("." + c + a + "texttitlespan").first().width() ? d("#" + c + a + "texttitle").hasClass(c + "Marquee") && (d("#" + c + a + "texttitle").removeClass(c + "Marquee"), d("#" + c + a + "texttitle").html(d("." + c + a + "texttitlespan").first()), d("#" + c + a + "texttitle").data("tcqstreamMarquee").pause()) : d("#" + c + a + "texttitle").hasClass(c + "Marquee") || (d("#" + c + a + "texttitle").addClass(c + "Marquee"), d("#" + c + a + "texttitle").html(d("." + c + a + "texttitlespan").first()), d("#" + c + a + "texttitle").tcqstreamMarquee())
            }
        }
        ...
        function yb(b) {
            ...
            d("#" + c + "buttonplay").css({
                ...
                transition: "fill 0.5s",
                fill: x
            }).html('<svg x="0px" y="0px"\t viewBox="0 0 800 800" ><path d="M22 12C22 6.46 17.54 2 12 2C10.83 2 9.7 2.19 8.62 2.56L9.32 4.5C10.17 4.16 11.06 3.97 12 3.97C16.41 3.97 20.03 7.59 20.03 12C20.03 16.41 16.41 20.03 12 20.03C7.59 20.03 3.97 16.41 3.97 12C3.97 11.06 4.16 10.12 4.5 9.28L2.56 8.62C2.19 9.7 2 10.83 2 12C2 17.54 6.46 22 12 22C17.54 22 22 17.54 22 12M5.47 3.97C6.32 3.97 7 4.68 7 5.47C7 6.32 6.32 7 5.47 7C4.68 7 3.97 6.32 3.97 5.47C3.97 4.68 4.68 3.97 5.47 3.97M18 12C18 8.67 15.33 6 12 6C8.67 6 6 8.67 6 12C6 15.33 8.67 18 12 18C15.33 18 18 15.33 18 12M15 12L10 15V9"/></svg>').on("mouseenter",
                function() {
                    d(this).css("fill", q)
                }).on("mouseleave", function() {
                d(this).css("fill", x)
            ...
            d("#" + c + "buttonpause").css({
                ...
                d(this).css("fill", x)
            }).fadeOut(0).tcqstreamdisableSelection();
            b = document.createElement("div");
        ...
        function wb(b) {
            ...
            d("#" + c + "backgroundimage").css({
                ...
                opacity: "900" //opacidad del Fondo cover Caratula
            });
        ...
        function ob(b) {
            ...
            d("#" + c + "smalltextradioname").css({
                ...
                "font-family": aa,
                color: x
            }).addClass(c + "smalltextradioname").html(d("." + c + "smalltextradionamespan")).tcqstreamdisableSelection();
            b = document.createElement("span");
            ...
            d("#" + c + "smalltexttitle").css({
                ...
                "font-family": aa,
                color: x
            }).addClass(c + "smalltexttitle").html(d("." + c + "smalltexttitlespan")).tcqstreamdisableSelection();
            b = document.createElement("div");
        ...
        function Ka() {
            E("playmode");
            try {
                d(".tcqaudioplayer").each(function() {
                    d(this).attr("id") != c && d(this).data("tcqstream").pause()
                })
            } catch (b) {
                E(b)
            }
        ...
        function la() {
            if ("fake" == V || "real" == V) {
                ...
                "hits1" == Da && d("#" + c + "smallcoverwrapper, #" + c + "smallcoverwrapper1, #" + c + "smallcoverwrapper2, #" + c + "coverwrapper, #" + c + "coverwrapper1, #" + c + "coverwrapper2").css({
        ...
        if (arguments.length) {
            ...
            var Kb = this;
            this.element.bind("remove.tcqstream", function() {
                Kb.destroy()
            })
        }
        for (var hb = t(w.token, ""), ja = t(w.userinterface, "small").toString().toLowerCase(), kb = t(w.backgroundcolor, "rgba(0,0,0,0)"), x = t(w.fontcolor, "#ffffff"), q = t(w.hightlightcolor, "#f86808"), aa = t(w.fontname, ""), ib = t(w.googlefont, ""), cb = t(w.fontratio, "0.4"), Ya = t(w.radioname, ""), zb = t(w.scroll, "true").toString().toLowerCase(), ma = t(w.coverimage, "data:image/png;base64,"),
                za = t(w.onlycoverimage, "false").toString().toLowerCase(), Da = t(w.coverstyle, "circle").toString().toLowerCase(), V = t(w.usevisualizer, "fake").toString().toLowerCase(), qa = parseInt(t(w.visualizertype, 4)), Xa = t(w.itunestoken, ""), fa = t(w.metadatatechnic, "php").toString().toLowerCase(), qb = t(w.ownmetadataurl, ""), ua = t(w.corsproxy, ""), lb = t(w.usestreamcorsproxy, "false").toString().toLowerCase(), Z = t(w.streamurl, ""), Va = t(w.streamtype, "other").toString().toLowerCase(), Ca = t(w.icecastmountpoint, ""), sb = t(w.radionomyid,""),
                    ...
                    tb = t(w.radionomyapikey, ""), zn = t(w.radiozenoid, ""), ub = t(w.radiojarid, ""), vb = t(w.radiocoid, ""), Gb = t(w.shoutcastpath, ""), rb = t(w.shoutcastid, ""), Hb = t(w.streamsuffix, "/;type=mp3"), pb = parseInt(t(w.metadatainterval, 2E4)), Za = parseInt(t(w.volume, 90)), Ib = t(w.debug, "false").toString().toLowerCase(),
                    ...
                    c, u = 0, C = 0, oa = "", M = 0, ba = 0, R = !1, jb = !1, eb, sa, l, ia, db, va = 0, wa = 0, g, La, B, Fa, r = [], W = [], Ma = 0, ya = [], ha = 0, Ga = !1, ka = (new tcqstreamParser).getResult(), Qa = !1, pa = "", U = 0; 511 > U; U += 1) ya.push(Math.floor(254 / (U / 100 + 1) * Math.random() + 1));
        ...
        d(document).ready(function() {
            var b = document.getElementsByTagName("script"),
                a, h;
            for (a = 0; h = b[a]; a++)
                if (h = h.src, 0 <= h.indexOf("tcqstream.min.js")) var f = h.substring(0, h.indexOf("tcqstream.min.js"));
            Y = f;
            E("SCRIPT FOLDER: " + Y);
            c = Jb;
            C = d("#" + c).width();
            ...
            "" != hb && -1 != b.indexOf(a) && 4 < a.length || b.indexOf("www.tcqstream.com") || (b = Oa(".creativoagencia.com"),
        ...
        jQuery.fn.extend({
            tcqstreamdisableSelection: function() {
                this.each(function() {
...
(function(d, D) {
    var m = {
        ...
        G = {
            browser: [
                ...
                [/(kindle)\/([\w\.]+)/i, /(tcqscape|maxthon|netfront|jasmine|blazer)[\/\s]?([\w\.]*)/i, /(avant\s|iemobile|slim)(?:browser)?[\/\s]?([\w\.]*)/i, /(bidubrowser|baidubrowser)[\/\s]?([\w\.]+)/i, /(?:ms|\()(ie)\s([\w\.]+)/i, /(rekonq)\/([\w\.]*)/i, /(chromium|flock|rockmelt|midori|epiphany|silk|skyfire|ovibrowser|bolt|iron|vivaldi|iridium|phantomjs|bowser|quark|qupzilla|falkon)\/([\w\.-]+)/i],
                ["name", "version"],
                [/(konqueror)\/([\w\.]+)/i],
                [
    ...
    "undefined" !== typeof exports ? ("undefined" !== typeof module && module.exports && (exports = module.exports =
        F), exports.tcqstreamParser = F) : "function" === typeof define && define.amd ? define(function() {
        return F
    }) : d && (d.tcqstreamParser = F);
...
(function(d, D) {
    ...
    d.fn.tcqstreamMarquee = function(m) {
        var w = "string" === typeof m,
            t = Array.prototype.slice.call(arguments, 1),
            K = this;
        m = !w && t.length ? d.extend.apply(null, [!0, m].concat(t)) : m;
        if (w && "_" === m.charAt(0)) return K;
        w ? this.each(function() {
            var G = d(this).data("tcqstreamMarquee"),
                F = G && d.isFunction(G[m]) ? G[m].apply(G, t) : G;
            if (F !== G && F !== D) return K = F, !1
        }) : this.each(function() {
            d(this).data("tcqstreamMarquee",
                new d.tcqstreamMarquee(this, m))
        });
        return K
    };
    d.tcqstreamMarquee = function(m, w) {
        function t() {
            var p = N ? -1 : 1,
                y = N ? -1 * G : 0;
...
(function(d) {
    ...
    var P = d.extend;
    m._binds = [];
    d.fn.tcqstreamgrab = function(e, p) {
    ...
    d.fn.tcqstreamungrab = function(e) {
        return this.each(function() {
